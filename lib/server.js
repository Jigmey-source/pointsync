...
import postrequests from './push_routes/post_requests.js';
import recordrequests from './push_routes/record_requests.js';
import userrequests from './push_routes/user_requests.js';

import pulldocs from './pull_routes/locality_bazaar.js';
import post from './pull_routes/post.js';
import store from './pull_routes/store.js';
import search from './push_routes/search.js';
import edit from './push_routes/edit.js';
