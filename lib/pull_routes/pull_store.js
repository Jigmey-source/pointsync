...
router.post(routes.recommend, async function (req, res) {
    ...
    try {
        ...
        incrementrecommendationsinrecord(req.body.locality, req.body.admninArea, req.body.common, 1);
...
function addrecommendation(link, data) {
    const entry = await stores.findOne({ link: link });
    entry.commends.push(data);
    entry.save(function (e, result) {
        if (e) {
...
router.post(routes.decrement, async function (req, res) {
    ...
    try {
        ...
        incrementrecommendationsinrecord(req.body.locality, req.body.admninArea, req.body.link, -1);
...
function incrementrecommendationsinrecord(locality, adminArea, link, i) {
    records.updateOne(
        { locality: locality, adminArea: adminArea, 'records.link': link },
        { $inc: { 'recommendations': i } },
        function (e, doc) {
            if (e) {
...
router.post(routes.newreview, async function (req, res) {
    ...
    try {
        ...
        incrementreviewinrecord(req.body.locality, req.body.adminArea, req.body.link, 1);
        res.json(review);
    } catch (e) {
...
function incrementreviewinrecord(locality, adminArea, link, i) {
    records.updateOne(
        { locality: locality, adminArea: adminArea, 'records.link': link },
        { $inc: { 'reviews': i } },
        function (e, doc) {
