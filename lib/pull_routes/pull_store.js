...
router.post(routes.newreview, async function (req, res) {
    ...
    try {
        ...
        console.log('out of calculateaverage rate babyyyyyyyy');
        console.log(rate);
        incrementreviewinstore(req.body.common, rate, 1);
        incrementreviewinrecord(req.body.common, rate);
        res.json(review);
    } catch (e) {
...
router.post(routes.deletereview, async function (req, res) {
    ...
    try {
        ...
        incrementreviewinrecord(req.body.link, rate);
...
async function calculateaveragerate(common) {
    ...
    console.log('rate rate rate rate rate ' + rate);
    return rate;
}
