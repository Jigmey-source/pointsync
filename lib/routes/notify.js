    ...
    notifications.updateOne(
        { userId: req.body.id },
        {
            $pull: {
                'notifications': {
                    $or: [
                        { mediaurl: req.body.link, comment: req.body.comment, userId: req.body.userId },
                        { mediaurl: req.body.link, type: req.body.type, userId: req.body.userId },
                        { mediaurl: req.body.link, review: req.body.review, userId: req.body.userId },
