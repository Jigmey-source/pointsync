...
router.post(routes.deletespecific, async function (req, res) {
    ...
    //     data = { mediaurl: req.body.link, comment: req.body.comment, userId: req.body.userId }
    // } else if (req.body.review != null) {
    //     data = { mediaurl: req.body.link, review: req.body.review, userId: req.body.userId }
    // } else {
    //     data = { mediaurl: req.body.link, type: req.body.type, userId: req.body.userId }
    // }
    console.log(data);
    try {
    ...
    //         $pull: {
    //             'notifications': field
    //             // 'notifications.$[el].comment': req.body.comment,
    //             // 'notifications.$[el].review': req.body.review,
    //         }
    //     },
    //     function (e, result) {
    //         if (e) {
