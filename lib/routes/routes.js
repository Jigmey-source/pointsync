...
router.post(routes.signUp, async function (req, res) {
    ...
    const mpost = new posts({ userId: req.body.userId });
...
router.post(routes.notifications, async function (req, res) {
    ...
    try {
        ...
        res.json('Notification saved succesffully');
    } catch (e) {
        res.json(e);
    }
});
...
router.post(routes.comments, async function (req, res) {
    comments.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e);
        } else {
            res.json(doc);
...
router.post(routes.followers, async function (req, res) {
    followers.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e);
        } else {
...
router.post(routes.likes, async function (req, res) {
    likes.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e);
        } else {
...
router.post(routes.notifications, async function (req, res) {
    notifications.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e);
        } else {
            res.json(doc);
...
router.post(routes.records, async function (req, res) {
    records.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e);
        } else {
            res.json(doc);
...
router.post(routes.reviews, async function (req, res) {
    reviews.find({ userId: req.body.userId }, function (e, doc) {
        if (e) {
            res.json(e)
        } else {
            res.json(doc);
