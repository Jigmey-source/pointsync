...
router.post(routes.addToSearch, async function (req, res) {
    ...
    try {
        ...
        entry.searched_users = searcheduser;
        await entry.save();
        ...
        //     }
        // });
        // user.$where({ userId: req.body.id }, function (err, doc) {
        //     if (err) {
        //         console.log(err);
        ...
        //     { userId: req.body.id },
        //     { '$addToSet': { searches: searcheduser } },
        // ).save();
        // user.find({ userId: req.body.id }, function (err, doc) {
        //     if (err) {
        //         console.log(err);
        //     } else {
