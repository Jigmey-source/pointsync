...
function notifyfollowee() {
    const token = 'f-twxabYQqGFjAIPsQSwdR:APA91bFQYd-qGhxrsYoLEjfXLjBD7HVpAKmdRJXAYX1VBhJ-ceacx6HnIXEZ5q_bU-JnHfP_ojoIi_sHOd2jWTfykuPXy29Dj4M-BaFdy36mFQ8FDP3e1rXJdxzTFw9JjI9j5nx1_8bn';
    try {
        const message = {
            token: token,
            notification: {
                title: 'Pointsync', body: 'tttttttrrrrrriiiiiaaaaaalllllllll',
                // image: imageUrl,
            },
        };
        admin.messaging()
